    ...
    private fun showNotification(title: String, description: String) {
        ...
        with(NotificationManagerCompat.from(this)) {
            if (ActivityCompat.checkSelfPermission(
                ...
                builder.setTitle("Требуется разрешение на уведомление")
                builder.setMessage("Этому приложению требуется разрешение на отправку уведомление, чтобы уведомлять вас о важных обновлениях.")
                builder.setPositiveButton("Разрешить") { dialog, _ ->
                    dialog.dismiss()
                }
